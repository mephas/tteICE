...
survival models. This strategy can be understood as the competing risks
model, which gives the subdistribution of the primary event.

## Usage

``` r
scr.whileon.eff(A, Time, status, Time_int, status_int, X = NULL)
```
