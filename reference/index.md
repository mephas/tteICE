...
- [`Surv.ice()`](https://mephas.github.io/tteICE/reference/Surv.ice.md)
  : Outcome def
...
- [`scr.composite()`](https://mephas.github.io/tteICE/reference/scr.composite.md)
  : Fit the CIF using composite variable strategy for semicompeting
  risks data
- [`scr.composite.eff()`](https://mephas.github.io/tteICE/reference/scr.composite.eff.md)
  : Fit the CIF using composite variable strategy for semicompeting
  risks data, based on efficient influence functions
- [`scr.natural()`](https://mephas.github.io/tteICE/reference/scr.natural.md)
  : Fit the CIF using hypothetical strategy (I) for semicompeting risks
  data
...
- [`scr.principal()`](https://mephas.github.io/tteICE/reference/scr.principal.md)
  : Fit the CIF using principal stratum strategy for semicompeting risks
  data
...
- [`scr.removed()`](https://mephas.github.io/tteICE/reference/scr.removed.md)
  : Fit the CIF using hypothetical strategy (II) for semicompeting risks
  data
...
- [`scr.treatment()`](https://mephas.github.io/tteICE/reference/scr.treatment.md)
  : Fit the CIF using treatment policy strategy for semicompeting risks
  data
...
- [`scr.whileon()`](https://mephas.github.io/tteICE/reference/scr.whileon.md)
  : Fit the CIF using while on treatment strategy for semicompeting
  risks data
...
- [`surv.boot()`](https://mephas.github.io/tteICE/reference/surv.boot.md)
  : Calculate the standard error for the estimated CIF and treatment
  effect
- [`surv.composite()`](https://mephas.github.io/tteICE/reference/surv.composite.md)
  : Fit the CIF using composite variable strategy for competing risks
  data
...
- [`surv.natural.eff()`](https://mephas.github.io/tteICE/reference/surv.natural.eff.md)
  : Fit the CIF using hypothetical strategy (I) for competing risks
  data, based on efficient influence functions
- [`surv.principal()`](https://mephas.github.io/tteICE/reference/surv.principal.md)
  : Fit the CIF using principal stratum strategy for competing risks
  data
...
- [`surv.removed()`](https://mephas.github.io/tteICE/reference/surv.removed.md)
  : Fit the CIF using hypothetical strategy (II) for competing risks
  data
...
- [`surv.treatment.eff()`](https://mephas.github.io/tteICE/reference/surv.treatment.eff.md)
  : Fit the CIF using treatment policy strategy for competing risks
  data, based on efficient influence functions
...
- [`surv.whileon()`](https://mephas.github.io/tteICE/reference/surv.whileon.md)
  : Fit the CIF using while on treatment strategy for competing risks
  data
...
- [`tteICE()`](https://mephas.github.io/tteICE/reference/tteICE.md) :
  Using formula to fit the CIF for time-to-event with intercurrent
  events
- [`tteICE2()`](https://mephas.github.io/tteICE/reference/tteICE2.md) :
  Using formula to fit the CIF for time-to-event with intercurrent
  events
