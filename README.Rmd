...
single composite outcome variable. <\cr>
...
which is intended to evaluate the direct and indirect effects for semi-competing risks data. <\cr>
...
closely related to the competing risks model. <\cr>
...
Reference: Deng, Y., Han, S., & Zhou, X. H. (2025). Inference for Cumulative Incidences and Treatment 
