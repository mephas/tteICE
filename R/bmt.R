...
#'
#' @description The \code{bmt} data frame has 137 rows and 22 columns.
#'
...
#'  \item{z3}{Patient Sex: 1-Male, 0-Female}
#'  \item{z4}{Donor Sex: 1-Male, 0-Female}
#'  \item{z5}{Patient CMV Status: 1-CMV Positive, 0-CMV Negative}
